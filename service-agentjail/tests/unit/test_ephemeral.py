...
class TestEphemeralRun:
    ...
    async def test_ephemeral_exit_code(
    ...
    async def test_ephemeral_combined_output(
        self, client: httpx.AsyncClient, mock_nsjail_run
    ):
        mock_nsjail_run.return_value = ExecResult(
    ...
    async def test_ephemeral_custom_time_limit(
        self, client: httpx.AsyncClient, mock_nsjail_run
    ):
        mock_nsjail_run.return_value = ExecResult(
    ...
    async def test_ephemeral_custom_memory_limit(
        self, client: httpx.AsyncClient, mock_nsjail_run
    ):
    ...
    async def test_ephemeral_cleanup_no_persist(
        self, client: httpx.AsyncClient, mock_nsjail_run
    ):
        mock_nsjail_run.return_value = ExecResult(
            exit_code=0, stdout="hello\n", stderr=""
    ...
    async def test_ephemeral_multiline_command(
        self, client: httpx.AsyncClient, mock_nsjail_run
    ):
        mock_nsjail_run.return_value = ExecResult(
    ...
    async def test_ephemeral_binary_not_found(
        self, client: httpx.AsyncClient, mock_nsjail_run
    ):
        mock_nsjail_run.return_value = ExecResult(
